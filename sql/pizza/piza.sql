...
/* --------------------------------------------------------- */
INSERT INTO Orders(orderDate,customerId) VALUES ('2019-05-15',1);
...
/* samih  didnt want any extras for his 2nd pizzaOrd (pizzaOrd with id = 33) */
